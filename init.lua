...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
        ...
        ltex = {
          on_attach = function(client, _)
            ...
            vim.api.nvim_create_user_command('LtexSwitchLang', function(args)
              ...
              local new_lang = splited_args[1]
              local ltexSettings = client.config.settings
              if ltexSettings ~= nil then
                ltexSettings.ltex.language = new_lang
      ...
      require('lspconfig')['marksman'].setup { filetypes = { 'markdown', 'quarto' } }
    end,
  },
    ...
    opts = {
      ...
      sources = {
        ...
        providers = {
          ...
          snippets = { opts = { search_paths = '~/.config/nvim-kickstart/snippets/' } },
        },
      },
